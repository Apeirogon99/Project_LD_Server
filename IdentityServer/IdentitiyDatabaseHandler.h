...
{
public:
	static void AddADOTask(PacketSessionPtr& inSession, ADOConnection& inADOConnection, ADOCommand& inCommand, ADORecordset& inRecordset, ADOCallBack inCallback)
	{
		...
		identityDatabase->GetTask().AddWork(inSession, inADOConnection, inCommand, inRecordset, inCallback);
	}
};

...
public:
	...
	static SendBufferPtr MakeSendBuffer(PacketSessionPtr session, Protocol::S2C_AppearNPC& pkt) { return PacketHandler::MakeSendBuffer(session, pkt, static_cast<uint16>(EPakcetID::S2C_AppearNPC)); }
